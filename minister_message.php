...
<div class="inner_page_wrapper">
    ...
    <Section class="inner_banner ">
        <div class="container_fluid">
            <div class="flex_row">
                <div class="col_8">
                    <h4>Minister's Message</h4>
                </div>

                <div class="col_4">
                    <ul class="new_breadcrumb">
                        <li><a href="<?php echo $base_url; ?>">Home</a></li>
                        <li>Minister's Message</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <!--Inner Banner End-->
    <!--First Section Start-->
    <section class="thematic_meetings common_spacing gradient_container">
        <div class="container_fluid">
            <div class="flex_row">
                <div class="col_6">
                    <div class="events_card">
                        <div class="events_card_content">
                                ...
                                <div class="pdf_document">
                                            <a href="assets/pdf/PIB1943493.pdf" target="_blank">
                    ...
                    <div class="events_card">
                        <div class="events_card_content">
                                ...
                                <p>
                                    ...
                                    standing united in their commitment to create a sustainable and resilient future.
                                </p>
                                 <!--Pdf Section Start-->
                                 <div class="pdf_document">
                                            <a href="assets/pdf/Press_Information_Bureau.pdf" target="_blank">
                                                <img src="assets/images/pdf_icon.webp" class="pdf_icon">
                                                <span>Read More</span>
                                            </a>
                                        </div>
