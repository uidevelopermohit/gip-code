...
<div class="inner_page_wrapper">
    ...
    <Section class="inner_banner">
        <div class="container_fluid">
            <div class="flex_row">
                <div class="col_8">
                    <h4>Media Coverage and Press Releases</h4>
                </div>
    ...
    <section class="common_spacing gradient_container">
        <div class="container_fluid">
            <div class="flex_row">
                <div class="col_12">
                    <ul class="tabbs">
                        <li class="active"><a href="#pressrelease">Press Releases</a></li>
                        <li><a href="#media_coverage">Media Coverage</a></li>
                        <li><a href="#events_reports">Event Reports</a></li>
                        <li><a href="#gallery">Gallery</a></li>
                    </ul>
                </div>
            </div>
            <div class="tab-content news_events" id="pressrelease">
    ...
    <section class="tab-content" id="media_coverage">
    ...
    <!--Event Reports-->
    <section class="tab-content" id="events_reports">
        <div class="container_fluid gradient_container">
                <div class="flex_row common_spacing">
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <div class="col_10">
                            <h5>Gandhinagar Implementation Roadmap And Gandhinagar Information Platform Presidency Document</h5>
                                <p><span class="read_more"><a href="assets/pdf/G20_ECSWG-GIR_GIP_for_Global_Land_Initiative.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>New Delhi Leaders’ Declaration</h5>
                                <p><span class="read_more"><a href="assets/pdf/G20-New-Delhi-Leaders-Declaration.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>G20 Background Brief</h5>
                                <p> <span class="read_more"><a href="assets/pdf/G20_Background_Brief.pdf" target="_blank">Read More</a></span></p>  
                            </div>
                        </div>
                        <hr>
                    </div>
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Compendium of Best Practices on restoration of Forest Fire Affected Areas</h5>
                                <p><span class="read_more"><a href="assets/pdf/G20_ECSWG-Compendium_of_Best_Practices_on_Restoration_of_Forest_Fire_Affected_Areas.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Compendium of Best Practices on restoration of Mining Affected Areas</h5>
                                <p><span class="read_more"><a href="assets/pdf/G20_ECSWG-Compendium_Best_Practices_on_Restoration_of_Mining_Affected_Areas.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Managing Forest Fires in a Changing Climate: Council on Energy Environment and Water (CEEW)</h5>
                                <p><span class="read_more"><a href="assets/pdf/ceew-research-on-states-prone-to-forest-wildfires-india-and-mitigation-methods.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Restoration of forest fire impacted areas- Karnataka Forest Department, India</h5>
                                <p> <span class="read_more"><a href="assets/pdf/Karnatka_Restoration_of_Forest_Fire_Impacted_Areas.pdf" target="_blank">Read More</a></span></p>  
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Forest fire disaster management report, The National Disaster Management Authority, India</h5>
                                <p><span class="read_more"><a href="assets/pdf/NDMA_forest_fire_report_India.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Forest Fire Management: Global Best Practices, National Disaster Management Authority, India</h5>
                                <p><span class="read_more"><a href="assets/pdf/BestPracticesForestFire_final.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Eco Friendly Approaches for Rehabilitation of Mine Spoils, Institute of Forest Genetics and Tree Breeding</h5>
                                <p><span class="read_more"><a href="assets/pdf/Approches_IFGTB_Eco_friendly_approaches_for_rehablitation_of_mine_spoils.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                ...
                <div class="flex_row common_spacing">
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <div class="col_10">
                            <h5>Developing Ecological Restoration Model In The Mine Spoils At Tetulmari Under Sijua Area (About 8-10
Ha) Of Bccl Mine, Forest
Ecology &amp; Environment
                    ...
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>Strengthening Forest Fire Management in India</h5>
                                <p><span class="read_more"><a href="assets/pdf/127284-Forest-Fire-Prevention-Management-8Oct2018.pdf" target="_blank">Read More</a></span></p>
                            </div>
                        </div>
                        <hr>
                    </div>
                    ...
                    <div class="col_6">
                        <div class="flex_row fix_hight">
                            ...
                            <h5>The Indian Forester</h5>
                                <p> <span class="read_more"><a href="assets/pdf/Special_Issue_on_Ecorestoration_Indian_Forester.pdf" target="_blank">Read More</a></span></p>  
                            </div>
                        </div>
                        <hr>
                    </div>
