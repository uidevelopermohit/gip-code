        ...
        <div class="container_fluid">
            <div class="sidebar_sticky_wrapper">
                ...
                <div class="sidebar_sticky_right">
                    ...
                    <div class="country_initiative_topic_wrapper" id="probable_international_gcf">
                        <div class="flex_row">
                            <div class="col_10">
                        ...
                        <div class="flex_row">
                            ...
                            <p>
                                i)Vulnerable people supported in Least Developed Countries (LDCs), Small Island Developing States (SIDS), African states and fragile and conflict states – including Afghanistan, Eritrea and Yemen. 
                            </p>

                            <p>
                                ii)“Hardest to Reach” project providing affordable and green energy access to first time users in low-income populations in 16 countries across Africa, including Somalia.
                            </p>
                            <p>
                                iii)Enhancing the climate resilience and livelihoods of indigenous peoples, including the indigenous wetlands communities in Peru – reducing greenhouse gas emissions from deforestation.
                            </p>
                            <p>
                                iv)Strengthening food security by supporting pioneering and early-growth agribusinesses of smallholder farmers including in Ghana, Kenya, Nigeria and Uganda.
                            </p>
                            <p>
                                v)Building the resilience of water supplies for communities, including in Vanuatu.
                            </p>
                            
                            <!--Pdf Section Start-->
                                <div class="pdf_document">
                                    <div class="col content_center">                                                
                                       <a target="blank" href="https://www.greenclimate.fund/news/gcf2-pledging-conference-replenishment#main-content">Source:GCF https://www.greenclimate.fund/gcf</a>
                                    </div><br><br>
                                </div>
                            <!--Pdf Section End-->
