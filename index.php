...
<div class="inner_page_wrapper">
        ...
        <!-- Minister Section Start-->
        <Section class="minister_Section common_spacing gradient_container">
            <div class="container_fluid">
                <div class="ministers_row">
                    ...
                    <div class="minister_second_col">
                        <div class="minister_card">
                            <div class="minister_card_image">
                                <img src="assets/images/ministersection/ministerimage.png" alt="">
                            </div>
                            <div class="minister_card_content">
            ...
            <div class="container_fluid">
                <div class="about_blocks_row">
                    ...
                    <div class="second_col">
                        <div class="about_cards about_cards_2">
                            <h5>G20 Presidency - India</h5>
                    ...
                    <div class="third_col">
                        <div class="about_cards about_cards_3">
                            <h5>History of GIP</h5>
                            <p>The Ministerial Communiqué of the G20 Environmental Ministers Meet during the Saudi
                                Arabia
        ...
        <section class="thematic_section common_spacing">
            ...
            <div class="thematic_section_card_wrapper">
                <a href="mining_affected_landscapes.php" class="thematic_section_card"
                    style="background-image: url('assets/images/thematic/mining_Affected_landscape.webp');">
                    <div class="thematic_section_card_content">
        ...
        <!--Event Section Start-->
        <section class="events_section common_spacing gradient_container">
            <div class="container_fluid">
        ...
        <section class="logos_section">
            <div class="container_fluid">
                <div class="logos_stripe">
                    <img src="assets/images/logos/Life1.png">
                    ...
                    <img src="assets/images/logos/image10.png">
                    <img src="assets/images/logos/UNDP_logo_1undp.png">
                </div>
            </div>
        </section>
        <!--Logo Section End-->
